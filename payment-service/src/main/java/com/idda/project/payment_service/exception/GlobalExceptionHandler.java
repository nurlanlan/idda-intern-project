package com.idda.project.payment_service.exception;

import com.idda.project.payment_service.dto.response.ErrorResponse;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<String> handleWebClientResponseException(WebClientResponseException ex) {
        log.error("Error from downstream service. Status: {}, Body: {}", ex.getStatusCode(), ex.getResponseBodyAsString());
